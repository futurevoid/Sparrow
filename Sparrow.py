...
async def on_message(message):
    ...
    if message.content.startswith('0xmute') or message.content.startswith('/mute'):
        ...
        await message.channel.send(f'{message.author.mention} Here is the bot invite link: [Invite Link](https://discord.com/api/oauth2/authorize?client_id=938395752873476096&permissions=8&scope=bot)')
