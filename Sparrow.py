...
async def on_message(message):
    ...
    if message.content.startswith('0xmute') or message.content.startswith('/mute'):
        ...
        embed = discord.Embed(title="Here is the bot invite link{0.author.mention}".format(message), description="[Invite Link](https://discord.com/api/oauth2/authorize?client_id=938395752873476096&permissions=8&scope=bot)".format(message))
        await message.channel.send(embed=embed)
